<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="HardSoft.App.ORL.Inicio" %>
...
-webkit-text-stroke-color:red; font-size:16px; margin-top: 2px;">
	...
	<section class="slider" id="home">
        ...
        <div id="ini" style="  padding:8px;     background-color: #e7e9e6;   " class="hidden-lg hidden-md">
   
        <div class="row" style="margin-top:18%; text-align:center;margin:auto; padding-top:80px">   
             <img src="img/3sMovil_V3.png" alt=""   border="0"   class=" img-responsive" style="margin:auto; padding-right:9px"  >
        
            
             <div class="row" style="margin-top:5px;margin-left:5px; margin-right: 8px; ">     
             <div  class="col-xs-3" style="padding:0px">
     <a href="whatsapp://send?phone=+541133894444">                 <img src="img/wsp1.png" alt=""  border="0"  class=" img-responsive pull-right" style="margin:auto"  >
        </a>
            </div> 
                    <div  class="col-xs-3" style="padding:0px ; margin-top: 0px;"> 
                         <a href="tel:+541142534310">
                             <img src="img/tel1.png" alt=""  border="0"  class=" img-responsive " style="margin:auto"  >
        </a>
            </div> 
                    <div  class="col-xs-3" style="padding:0px; margin-top:0px">
                         <a href="Reservar.aspx" >
                             <img src="img/turno1.png" alt=""  border="0"  class=" img-responsive pull-left" style="margin:auto"  >
        </a>
            </div> 

                     <div  class="col-xs-3" style="padding:0px; margin-top:0px">
                         <a href="mailto:corldequilmes@gmail.com">
                             <img src="img/mail1.png" alt=""  border="0"  class=" img-responsive pull-left" style="margin:auto"  >
        </a>
            </div> 
...
<li>Nutr. Lía Cristina Cespi</li>
 <li>Mariano Aguilo</li>
    ...
    <div class="modal fade" id="myModal221" role="dialog" style="display:none; margin-top:80px">
    <div class="modal-dialog modal-lg">
     ...
     <%--   <div class="modal-header">
          ...
          <h3 class="modal-title alert-danger" >  AVISO CORONAVIRUS </h3>
        </div>--%>
...
">
   ...
   <%--  <h2>AVISO CORONAVIRUS</h2>
        
    <p>

 En vista de la “Cuarentena Sanitaria” dispuesta por el Gobierno Nacional y nuestro convencimiento que dicha medida (AISLAMIENTO) resulta de vital importancia para enfrentar esta etapa de la pandemia,
<span style="color:red;font-size:21px;font-weight:800">  Hemos decidido SUSPENDER LA ATENCION PRESENCIAL hasta el 1/4/20. </span> --%>

   <h2>Estimados pacientes</h2>
        
     <p>  En vista de la cuarentena decretada por el gobierno estamos atendiendo presencialmente <span style="color:red;font-size:21px;font-weight:800"> Urgencias </span>
          de la especialidad los días lunes a viernes de 15 a 19hs, con turno telefónico o vía web. <br />
Como hace 40 años estamos, ininterrumpidamente, al servicio de la comunidad de nuestra ciudad. </p>
        
     
<span style=" 
;  ">  Mientras dure la cuarentena decretada por las autoridades nacionales. </span>
    
    <br /> <br /><span style=" font-size:21px;font-weight:800">Para otras consultas estaremos a vuestra disposición Via:  </span>  <br/>
 Mail: corldequilmes@gmail.com <br/>
Whatsapp: 1133894444 <br/> 
 ...
 <script>
     ...
     jQuery(function ($) {
         ...
         if (ancho < 720) {
             ...
             $('html, body').css('background-color', '#e7e9e6');
